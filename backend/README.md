...
## Project Structure
    ...
    ├── hair_savage_drip_st_36781  # Django project configurations
...
1. Clone this repo and `cd hair_savage_drip_st_36781`
...
2. Clone this repo and `cd hair_savage_drip_st_36781`
